...
class Opamp_Dense(torch.nn.Module):
    def __init__(self, in_neurons, out_neurons, rf, cf, clock_freq, vth, std_gain=None):
        super(Opamp_Dense, self).__init__()
        self.const = 2 * rf * cf * clock_freq
